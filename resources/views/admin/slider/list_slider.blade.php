                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{route('admin.slider.slider_add')}}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.slider.slider_edit',[$item->id])}}"><i class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                            <td>
                                <a href="{{route('admin.slider.slider_delete',[$item->id])}}"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                          @endforeach
