                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ten_giangvien" id="name" class="form-control" value="@isset($request['ten_giangvien']){{ $request['ten_giangvien'] }}@endisset">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="dia_chi" id="" class="form-control" value="@isset($request['dia_chi']){{ $request['dia_chi'] }}@endisset">
                                <span id="mes_sdt"></span>
                                @error('dia_chi')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="email" name="email" id="" class="form-control" value="@isset($request['email']){{ $request['email'] }}@endisset">
                                <span id="mes_sdt"></span>
                                @error('email')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="sdt" id="" class="form-control" value="@isset($request['sdt']){{ $request['sdt'] }}@endisset">
                                <span id="mes_sdt"></span>
                                @error('sdt')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
