                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            <input type="text" name="search" class="form-control" placeholder="Tên người dùng"
                                   value="">
                        </div>
                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{route('admin.giangvien.giangvien_add')}}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    <img src="{{asset($item->hinh_anh)}}" width="150px" alt="">
                                </center>
                            </td>
                            <td>{{$item->dia_chi}}</td>
                            <td>{{$item->email}}</td>
                            <td>{{$item->sdt}}</td>
                            <td class="button">
                                <a href="{{route('admin.giangvien.giangvien_edit',[$item->id])}}"><i class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                            <td><a onclick="confirm('Xóa giảng viên thành công!')" href="{{route('admin.giangvien.giangvien_delete',[$item->id])}}"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                          @endforeach
