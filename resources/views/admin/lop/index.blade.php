                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            <input type="text" name="search" class="form-control" placeholder="Tên lớp"
                                   value="">
                        </div>
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">Chi tiết lớp</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a style="color:#333333;font-weight: bold;" href="{{route('admin.lop.detail_lop',[$item->id])}}" style="white-space:unset;text-align: justify;">Chi tiết</a>
                            </td>
                            <td>
