                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('admin/danhmuc') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{route('admin.khuyenmai.khuyenmai_add')}}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{$item->giam_tien}}</td>
                            <td>{{ date('d-m-Y', strtotime($item->created_at)) }}</td>
                            <td>{{$item->ngay_ket_thuc}}</td>
                            <td><a href="{{route('admin.khuyenmai.khuyenmai_edit',[$item->id])}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                            <td><a class="delete" data-url="{{route('admin.khuyenmai.khuyenmai_delete',[$item->id])}}"><i class="fa-solid fa-trash-can"></i></a></td>
