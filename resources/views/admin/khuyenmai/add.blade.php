...
@section('content')
    ...
    <form class="form-horizontal " action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="text" name="ma_khuyenmai" id="ma_khuyenmai" class="form-control" value="">
                        ...
                        <div class="col-md-9 col-sm-8">   
                            <select name="id_khoahoc" id="">
                                @foreach ($khoahocs as $it)
                                    <option value="{{$it->id}}">{{$it->ten_khoahoc}}</option>
                                @endforeach
                            </select>
                            @error('id_khoahoc')
                                <div class="text-danger">{{$message}}</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="text" name="giam_tien" id="giam_tien" class="form-control" value="">
                            <span id="mes_sdt"></span>
                            @error('giam_tien')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="date" name="ngay_ket_thuc" id="ngay_ket_thuc" class="form-control" value="">
                            <span id="mes_sdt"></span>
                            @error('ngay_ket_thuc')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
        ...
        <div class="text-center">
            ...
            <a href="{{ route('admin.khuyenmai.index') }}" class="btn btn-default">Cancel</a>
        </div>
        <!-- /.box-footer -->
    </form>
