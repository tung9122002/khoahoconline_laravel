                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="alldata">
                            ...
                            <tr >
                                ...
                                <td><a onclick="confirm('Bạn đã xóa người dùng thành công!')" href="{{route('admin.user.User_delete',[$item->id])}}"><i class="fa-solid fa-trash-can"></i></a></td>
                            </tr>
                              @endforeach
                            </tbody>
...
{{-- <script>
     $('#search').keyup(function(){ //bắt sự kiện keyup khi người dùng gõ từ khóa tim kiếm
      $value = $(this).val(); //lấy gía trị ng dùng gõ
       ...
       $.ajax({
        type:'get',
        url:"{{ route('admin.user.search') }}", // đường dẫn khi gửi dữ liệu đi 'search' là tên route mình đặt bạn mở route lên xem là hiểu nó là cái j.
        data:{'search':$value},
        success:function(data){ //dữ liệu nhận về
            
         $('#Content').html(data);  //nhận dữ liệu dạng html và gán vào cặp thẻ có id là content
       }
     });
    });
