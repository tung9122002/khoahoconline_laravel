                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ten_khoahoc" id="name" class="form-control" value="@isset($request['ten_khoahoc']){{ $request['ten_khoahoc'] }}@endisset">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="mo_ta" id="" class="form-control" value="@isset($request['mo_ta']){{ $request['mo_ta'] }}@endisset">
                                <span id="mes_sdt"></span>
                                @error('mo_ta')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="date" name="ngay_dang" id="" class="form-control" value="@isset($request['ngay_dang']){{ $request['ngay_dang'] }}@endisset">
                                <span id="mes_sdt"></span>
                                @error('ngay_dang')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="so_luot_xem" id="" placeholder="0" class="form-control" value="0" disabled>
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <select name="id_danhmuc" id="">
                                    ...
                                    <option class="form-control" value="<?=$it->id ?>"> <?=$it->ten_danhmuc?></option>
                                    <?php endforeach?>
                                    </select>
                                    <span id="mes_sdt"></span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <select name="id_giangvien" id="">
                                    ...
                                    <option class="form-control" value="<?=$it->id ?>"> <?=$it->ten_giangvien?></option>
                                    <?php endforeach?>
                                    </select>
                                    <span id="mes_sdt"></span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="gia_khoahoc" id="" placeholder="0" class="form-control" value="@isset($request['gia_khoahoc']){{ $request['gia_khoahoc'] }}@endisset">
                                <span id="mes_sdt"></span>
                                @error('gia_khoahoc')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
